        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BeerStyle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Upc = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MinOnHand = table.Column<int>(type: "int", nullable: false),
                    QuantityToBrew = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
